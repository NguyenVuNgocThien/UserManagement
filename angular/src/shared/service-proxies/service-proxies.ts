...
export class UserServiceProxy {
     ...
     * @return Success
     */
    getFileImport(file: FileParameter | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/User/GetFileImport";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetFileImport(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetFileImport(<any>response_);
                } catch (e) {
    ...
    protected processGetFileImport(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * @param pathFile (optional) 
     * @return Success
     */
    importFile(pathFile: string | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/User/ImportFile?";
        if (pathFile === null)
            throw new Error("The parameter 'pathFile' cannot be null.");
        else if (pathFile !== undefined)
            url_ += "pathFile=" + encodeURIComponent("" + pathFile) + "&";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processImportFile(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    updateMultiUser(body: ImportUserReqDto[] | undefined): Observable<{ [key: string]: any; }> {
        let url_ = this.baseUrl + "/api/services/app/User/UpdateMultiUser";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateMultiUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateMultiUser(<any>response_);
                } catch (e) {
    ...
    protected processUpdateMultiUser(response: HttpResponseBase): Observable<{ [key: string]: any; }> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    createOrEditMultiUser(body: ImportUserReqDto | undefined): Observable<{ [key: string]: any; }> {
        let url_ = this.baseUrl + "/api/services/app/User/CreateOrEditMultiUser";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateOrEditMultiUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateOrEditMultiUser(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string]: any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateOrEditMultiUser(response: HttpResponseBase): Observable<{ [key: string]: any; }> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ImportUserReqDto implements IImportUserReqDto {
    id: number;
    ...
    static fromJS(data: any): ImportUserReqDto {
        data = typeof data === 'object' ? data : {};
        let result = new ImportUserReqDto();
        result.init(data);
        return result;
    }
...
export interface IImportUserReqDto {
    id: number;
    firstName: string | undefined;
    lastName: string | undefined;
    phoneNumber: string | undefined;
